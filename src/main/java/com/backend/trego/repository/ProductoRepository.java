...
public interface ProductoRepository extends JpaRepository<Producto, Integer> {
	...
	List<Producto> findByRestauranteHabilitadoTrueAndRestauranteAbiertoTrueAndDisponibleTrueOrderBySubcategoriaIdAsc();

	List<Producto> findByRestauranteHabilitadoTrueAndRestauranteAbiertoTrueAndDisponibleTrueAndOfertaActivaTrueOrderByOfertaIdDesc();
}
